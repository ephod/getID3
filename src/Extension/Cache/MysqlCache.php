 ...
 *       $getID3 = new getID3_cached_mysql('localhost', 'database', 'username',
 * 'password', 'tablename');
 *       $getID3->encoding = 'UTF-8';
 *       $info1 = $getID3->analyze('file1.flac');
 *       $info2 = $getID3->analyze('file2.wv');
...
class MysqlCache extends GetId3
{
    ...
    {
        $this->cursor = mysql_query('DELETE FROM `'.mysql_real_escape_string($this->table).'`',
          $this->connection);
     ...
     * @param bool $drop
     */
    private function create_table(?bool $drop = false): void
    {
